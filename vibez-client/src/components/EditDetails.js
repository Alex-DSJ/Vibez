...
class EditDetails extends Component {
    ...
    mapUserDetailsToState=(credentials)=>{//creating this function to avoid repeating the code for the two above functions
        this.setState({
    ...
    render() {
        ...
        return (
            <Fragment>
                <MyButton tip="Edit details" onClick={this.handleOpen} btmClassName="button">
                ...
                <Dialog 
                    ...
                    fullWidth
                    maxWidth="sm"//check the website for more details
                >
